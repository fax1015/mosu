<script>
  ...
  $: todoIds = $coreState.todoIds || [];
  $: doneIds = $coreState.doneIds || [];
  $: isPinned = !!itemId && todoIds.includes(itemId);
...
<div
  class="list-box list-box--flow {isPinned && !isDone ? 'is-pinned' : ''} {isDone
    ? 'is-done'
    : ''}"
  data-item-id={itemId}
>
  <div class="list-main">
    <div class="list-details">
      ...
      <div class="list-action-links">
        ...
        <button
          type="button"
          class="beatmap-link"
          aria-label="Show beatmap in folder"
    ...
    <div class="list-right">
      ...
      {#if !isDone}
        <button
          type="button"
          class="pin-btn {isPinned ? 'is-active' : ''}"
          aria-label={isPinned ? "Unpin from Todo" : "Pin to Todo"}
          data-tooltip={isPinned ? "Unpin from Todo" : "Pin to Todo"}
