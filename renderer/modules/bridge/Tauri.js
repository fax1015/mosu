...
export const beatmapApi = window.beatmapApi || {
    ...
    openMapperOsuFiles: (mapperName, clientType) => { throw new Error('Tauri not available'); },
    openFolderOsuFiles: (clientType) => { throw new Error('Tauri not available'); },
    readImage: (filePath) => { throw new Error('Tauri not available'); },
    readBinary: (filePath) => { throw new Error('Tauri not available'); },
    readAudio: (filePath, fileNameHint) => { throw new Error('Tauri not available'); },
    readOsuFile: (filePath) => { throw new Error('Tauri not available'); },
    statFile: (filePath) => { throw new Error('Tauri not available'); },
    parseStableCollections: (path) => { throw new Error('Tauri not available'); },
    addToStableCollection: (collectionDbPath, collectionName, beatmapHash) => { throw new Error('Tauri not available'); },
    getLazerCollections: (dataRoot) => { throw new Error('Tauri not available'); },
    addToLazerCollection: (dataRoot, collectionName, beatmapHash) => { throw new Error('Tauri not available'); },
    prepareLazerMapSession: (filePath, dataRoot) => { throw new Error('Tauri not available'); },
    commitLazerMapSession: (sessionDir) => { throw new Error('Tauri not available'); },
    scanDirectoryOsuFiles: (dirPath, mapperName, knownFiles, clientType) => { throw new Error('Tauri not available'); },
    listDirectoryOsuFiles: (dirPath, mapperName, clientType) => { throw new Error('Tauri not available'); },
    selectDirectory: (title) => { throw new Error('Tauri not available'); },
    ...
    getAudioDuration: (filePath, fileNameHint) => { throw new Error('Tauri not available'); },
